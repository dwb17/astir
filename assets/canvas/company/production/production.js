...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	var mask_graphics_68 = new cjs.Graphics().p("AraCFIAAkJIW1AAIAAEJg");
	var mask_graphics_69 = new cjs.Graphics().p("ArgDiIAAnDIXBAAIAAHDg");
	var mask_graphics_70 = new cjs.Graphics().p("ArmE/IAAp9IXNAAIAAJ9g");
	var mask_graphics_71 = new cjs.Graphics().p("ArsGcIAAs3IXZAAIAAM3g");
	var mask_graphics_72 = new cjs.Graphics().p("AryH5IAAvxIXlAAIAAPxg");
	var mask_graphics_73 = new cjs.Graphics().p("Ar5JWIAAyrIXzAAIAASrg");
	var mask_graphics_74 = new cjs.Graphics().p("Ar/KzIAA1lIX/AAIAAVlg");
	var mask_graphics_75 = new cjs.Graphics().p("AsFMQIAA4fIYLAAIAAYfg");
	var mask_graphics_76 = new cjs.Graphics().p("AsLNtIAA7ZIYXAAIAAbZg");
	var mask_graphics_77 = new cjs.Graphics().p("AsRPKIAA+TIYjAAIAAeTg");
	var mask_graphics_78 = new cjs.Graphics().p("AsYQnMAAAghNIYxAAMAAAAhNg");
	var mask_graphics_79 = new cjs.Graphics().p("AseSFMAAAgkIIY9AAMAAAAkIg");
	var mask_graphics_80 = new cjs.Graphics().p("AskTiMAAAgnDIZJAAMAAAAnDg");
	var mask_graphics_81 = new cjs.Graphics().p("AsqU/MAAAgp9IZVAAMAAAAp9g");
	var mask_graphics_82 = new cjs.Graphics().p("AswWcMAAAgs3IZhAAMAAAAs3g");
	var mask_graphics_83 = new cjs.Graphics().p("As3X5MAAAgvxIZvAAMAAAAvxg");
	var mask_graphics_84 = new cjs.Graphics().p("As9ZWMAAAgyrIZ7AAMAAAAyrg");
	var mask_graphics_85 = new cjs.Graphics().p("EA76AhPMAAAg1lIaJAAMAAAA1lg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(67).to({graphics:mask_graphics_67,x:1027.8,y:422.1}).wait(1).to({graphics:mask_graphics_68,x:1027.2,y:412.8}).wait(1).to({graphics:mask_graphics_69,x:1026.6,y:403.4}).wait(1).to({graphics:mask_graphics_70,x:1026.1,y:394.1}).wait(1).to({graphics:mask_graphics_71,x:1025.5,y:384.7}).wait(1).to({graphics:mask_graphics_72,x:1025,y:375.4}).wait(1).to({graphics:mask_graphics_73,x:1024.4,y:366}).wait(1).to({graphics:mask_graphics_74,x:1023.9,y:356.7}).wait(1).to({graphics:mask_graphics_75,x:1023.3,y:347.3}).wait(1).to({graphics:mask_graphics_76,x:1022.8,y:338}).wait(1).to({graphics:mask_graphics_77,x:1022.2,y:328.7}).wait(1).to({graphics:mask_graphics_78,x:1021.6,y:319.3}).wait(1).to({graphics:mask_graphics_79,x:1021.1,y:310}).wait(1).to({graphics:mask_graphics_80,x:1020.5,y:300.6}).wait(1).to({graphics:mask_graphics_81,x:1020,y:291.3}).wait(1).to({graphics:mask_graphics_82,x:1019.4,y:281.9}).wait(1).to({graphics:mask_graphics_83,x:1018.9,y:272.6}).wait(1).to({graphics:mask_graphics_84,x:1018.3,y:263.2}).wait(1).to({graphics:mask_graphics_85,x:550.7,y:212.7}).wait(15));
	...
	var mask_1_graphics_57 = new cjs.Graphics().p("AsaBmIAAjLIY1AAIAADLg");
	var mask_1_graphics_58 = new cjs.Graphics().p("AsaB8IAAj3IY1AAIAAD3g");
	var mask_1_graphics_59 = new cjs.Graphics().p("AsaCTIAAklIY1AAIAAElg");
	var mask_1_graphics_60 = new cjs.Graphics().p("AsaCpIAAlRIY1AAIAAFRg");
	var mask_1_graphics_61 = new cjs.Graphics().p("AsaDAIAAl/IY1AAIAAF/g");
	var mask_1_graphics_62 = new cjs.Graphics().p("AsaDWIAAmrIY1AAIAAGrg");
	var mask_1_graphics_63 = new cjs.Graphics().p("AsaDtIAAnZIY1AAIAAHZg");
	var mask_1_graphics_64 = new cjs.Graphics().p("AsaEDIAAoFIY1AAIAAIFg");
	var mask_1_graphics_65 = new cjs.Graphics().p("AsaEaIAAozIY1AAIAAIzg");
	var mask_1_graphics_66 = new cjs.Graphics().p("AsaEwIAApfIY1AAIAAJfg");
	var mask_1_graphics_67 = new cjs.Graphics().p("AsaFHIAAqNIY1AAIAAKNg");
	var mask_1_graphics_68 = new cjs.Graphics().p("AsaFdIAAq5IY1AAIAAK5g");
	var mask_1_graphics_69 = new cjs.Graphics().p("AsaF0IAArnIY1AAIAALng");
	var mask_1_graphics_70 = new cjs.Graphics().p("AsaGKIAAsTIY1AAIAAMTg");
	var mask_1_graphics_71 = new cjs.Graphics().p("AsaGhIAAtBIY1AAIAANBg");
	var mask_1_graphics_72 = new cjs.Graphics().p("AsaG3IAAttIY1AAIAANtg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(56).to({graphics:mask_1_graphics_56,x:869.7,y:169.1}).wait(1).to({graphics:mask_1_graphics_57,x:869.7,y:166.4}).wait(1).to({graphics:mask_1_graphics_58,x:869.7,y:163.8}).wait(1).to({graphics:mask_1_graphics_59,x:869.7,y:161.2}).wait(1).to({graphics:mask_1_graphics_60,x:869.7,y:158.6}).wait(1).to({graphics:mask_1_graphics_61,x:869.7,y:155.9}).wait(1).to({graphics:mask_1_graphics_62,x:869.7,y:153.3}).wait(1).to({graphics:mask_1_graphics_63,x:869.7,y:150.7}).wait(1).to({graphics:mask_1_graphics_64,x:869.7,y:148.1}).wait(1).to({graphics:mask_1_graphics_65,x:869.7,y:145.5}).wait(1).to({graphics:mask_1_graphics_66,x:869.7,y:142.8}).wait(1).to({graphics:mask_1_graphics_67,x:869.7,y:140.2}).wait(1).to({graphics:mask_1_graphics_68,x:869.7,y:137.6}).wait(1).to({graphics:mask_1_graphics_69,x:869.7,y:135}).wait(1).to({graphics:mask_1_graphics_70,x:869.7,y:132.3}).wait(1).to({graphics:mask_1_graphics_71,x:869.7,y:129.7}).wait(1).to({graphics:mask_1_graphics_72,x:869.7,y:127.1}).wait(28));
	...
	var mask_2_graphics_47 = new cjs.Graphics().p("AsaBTIAAilIY1AAIAAClg");
	var mask_2_graphics_48 = new cjs.Graphics().p("AsaBvIAAjdIY1AAIAADdg");
	var mask_2_graphics_49 = new cjs.Graphics().p("AsaCLIAAkVIY1AAIAAEVg");
	var mask_2_graphics_50 = new cjs.Graphics().p("AsaCnIAAlNIY1AAIAAFNg");
	var mask_2_graphics_51 = new cjs.Graphics().p("AsaDEIAAmHIY1AAIAAGHg");
	var mask_2_graphics_52 = new cjs.Graphics().p("AsaDgIAAm/IY1AAIAAG/g");
	var mask_2_graphics_53 = new cjs.Graphics().p("AsaD8IAAn3IY1AAIAAH3g");
	var mask_2_graphics_54 = new cjs.Graphics().p("AsaEYIAAovIY1AAIAAIvg");
	var mask_2_graphics_55 = new cjs.Graphics().p("AsaE0IAApnIY1AAIAAJng");
	var mask_2_graphics_56 = new cjs.Graphics().p("AsaFQIAAqgIY1AAIAAKgg");
	var mask_2_graphics_57 = new cjs.Graphics().p("AsaFtIAArZIY1AAIAALZg");
	var mask_2_graphics_58 = new cjs.Graphics().p("AsaGJIAAsRIY1AAIAAMRg");
	var mask_2_graphics_59 = new cjs.Graphics().p("AsaGlIAAtJIY1AAIAANJg");
	var mask_2_graphics_60 = new cjs.Graphics().p("AsaHBIAAuBIY1AAIAAOBg");
	var mask_2_graphics_61 = new cjs.Graphics().p("AsaHdIAAu6IY1AAIAAO6g");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(46).to({graphics:mask_2_graphics_46,x:717.7,y:218.6}).wait(1).to({graphics:mask_2_graphics_47,x:717.7,y:215.7}).wait(1).to({graphics:mask_2_graphics_48,x:717.7,y:212.8}).wait(1).to({graphics:mask_2_graphics_49,x:717.7,y:210}).wait(1).to({graphics:mask_2_graphics_50,x:717.7,y:207.1}).wait(1).to({graphics:mask_2_graphics_51,x:717.7,y:204.3}).wait(1).to({graphics:mask_2_graphics_52,x:717.7,y:201.4}).wait(1).to({graphics:mask_2_graphics_53,x:717.7,y:198.6}).wait(1).to({graphics:mask_2_graphics_54,x:717.7,y:195.7}).wait(1).to({graphics:mask_2_graphics_55,x:717.7,y:192.8}).wait(1).to({graphics:mask_2_graphics_56,x:717.7,y:190}).wait(1).to({graphics:mask_2_graphics_57,x:717.7,y:187.1}).wait(1).to({graphics:mask_2_graphics_58,x:717.7,y:184.3}).wait(1).to({graphics:mask_2_graphics_59,x:717.7,y:181.4}).wait(1).to({graphics:mask_2_graphics_60,x:717.7,y:178.6}).wait(1).to({graphics:mask_2_graphics_61,x:717.7,y:175.7}).wait(39));
	...
	var mask_3_graphics_36 = new cjs.Graphics().p("AsfBOIAAibIY/AAIAACbg");
	var mask_3_graphics_37 = new cjs.Graphics().p("AsfBlIAAjJIY/AAIAADJg");
	var mask_3_graphics_38 = new cjs.Graphics().p("AsfB8IAAj3IY/AAIAAD3g");
	var mask_3_graphics_39 = new cjs.Graphics().p("AsfCTIAAklIY/AAIAAElg");
	var mask_3_graphics_40 = new cjs.Graphics().p("AsfCqIAAlTIY/AAIAAFTg");
	var mask_3_graphics_41 = new cjs.Graphics().p("AsfDBIAAmBIY/AAIAAGBg");
	var mask_3_graphics_42 = new cjs.Graphics().p("AsfDYIAAmvIY/AAIAAGvg");
	var mask_3_graphics_43 = new cjs.Graphics().p("AsfDvIAAndIY/AAIAAHdg");
	var mask_3_graphics_44 = new cjs.Graphics().p("AsfEHIAAoNIY/AAIAAINg");
	var mask_3_graphics_45 = new cjs.Graphics().p("AsfEeIAAo7IY/AAIAAI7g");
	var mask_3_graphics_46 = new cjs.Graphics().p("AsfE1IAAppIY/AAIAAJpg");
	var mask_3_graphics_47 = new cjs.Graphics().p("AsfFMIAAqXIY/AAIAAKXg");
	var mask_3_graphics_48 = new cjs.Graphics().p("AsfFjIAArFIY/AAIAALFg");
	var mask_3_graphics_49 = new cjs.Graphics().p("AsfF6IAArzIY/AAIAALzg");
	var mask_3_graphics_50 = new cjs.Graphics().p("AsfGRIAAshIY/AAIAAMhg");
	var mask_3_graphics_51 = new cjs.Graphics().p("AsfGoIAAtPIY/AAIAANPg");
	var mask_3_graphics_52 = new cjs.Graphics().p("AsfHAIAAt/IY/AAIAAN/g");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(35).to({graphics:mask_3_graphics_35,x:567.1,y:264.6}).wait(1).to({graphics:mask_3_graphics_36,x:567.1,y:262.3}).wait(1).to({graphics:mask_3_graphics_37,x:567.1,y:260}).wait(1).to({graphics:mask_3_graphics_38,x:567.1,y:257.7}).wait(1).to({graphics:mask_3_graphics_39,x:567.1,y:255.4}).wait(1).to({graphics:mask_3_graphics_40,x:567.1,y:253.1}).wait(1).to({graphics:mask_3_graphics_41,x:567.1,y:250.8}).wait(1).to({graphics:mask_3_graphics_42,x:567.1,y:248.5}).wait(1).to({graphics:mask_3_graphics_43,x:567.1,y:246.2}).wait(1).to({graphics:mask_3_graphics_44,x:567.1,y:243.9}).wait(1).to({graphics:mask_3_graphics_45,x:567.1,y:241.6}).wait(1).to({graphics:mask_3_graphics_46,x:567.1,y:239.3}).wait(1).to({graphics:mask_3_graphics_47,x:567.1,y:237}).wait(1).to({graphics:mask_3_graphics_48,x:567.1,y:234.7}).wait(1).to({graphics:mask_3_graphics_49,x:567.1,y:232.4}).wait(1).to({graphics:mask_3_graphics_50,x:567.1,y:230.1}).wait(1).to({graphics:mask_3_graphics_51,x:567.1,y:227.8}).wait(1).to({graphics:mask_3_graphics_52,x:567.1,y:225.6}).wait(48));
	...
	var mask_4_graphics_25 = new cjs.Graphics().p("AspBiIAAjDIZSAAIAADDg");
	var mask_4_graphics_26 = new cjs.Graphics().p("AspB6IAAjzIZSAAIAADzg");
	var mask_4_graphics_27 = new cjs.Graphics().p("AspCSIAAkjIZSAAIAAEjg");
	var mask_4_graphics_28 = new cjs.Graphics().p("AspCpIAAlRIZSAAIAAFRg");
	var mask_4_graphics_29 = new cjs.Graphics().p("AspDBIAAmBIZSAAIAAGBg");
	var mask_4_graphics_30 = new cjs.Graphics().p("AspDZIAAmxIZSAAIAAGxg");
	var mask_4_graphics_31 = new cjs.Graphics().p("AspDxIAAnhIZSAAIAAHhg");
	var mask_4_graphics_32 = new cjs.Graphics().p("AspEIIAAoPIZSAAIAAIPg");
	var mask_4_graphics_33 = new cjs.Graphics().p("AspEgIAAo/IZSAAIAAI/g");
	var mask_4_graphics_34 = new cjs.Graphics().p("AspE4IAApvIZSAAIAAJvg");
	var mask_4_graphics_35 = new cjs.Graphics().p("AspFQIAAqfIZSAAIAAKfg");
	var mask_4_graphics_36 = new cjs.Graphics().p("AspFnIAArNIZSAAIAALNg");
	var mask_4_graphics_37 = new cjs.Graphics().p("AspF/IAAr9IZSAAIAAL9g");
	var mask_4_graphics_38 = new cjs.Graphics().p("AspGXIAAstIZSAAIAAMtg");
	var mask_4_graphics_39 = new cjs.Graphics().p("AspGvIAAtdIZSAAIAANdg");
	var mask_4_graphics_40 = new cjs.Graphics().p("AspHGIAAuLIZSAAIAAOLg");
	var mask_4_graphics_41 = new cjs.Graphics().p("AspHeIAAu7IZSAAIAAO7g");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(24).to({graphics:mask_4_graphics_24,x:415.1,y:308.6}).wait(1).to({graphics:mask_4_graphics_25,x:415.1,y:306.2}).wait(1).to({graphics:mask_4_graphics_26,x:415.1,y:303.8}).wait(1).to({graphics:mask_4_graphics_27,x:415.1,y:301.4}).wait(1).to({graphics:mask_4_graphics_28,x:415.1,y:299}).wait(1).to({graphics:mask_4_graphics_29,x:415.1,y:296.5}).wait(1).to({graphics:mask_4_graphics_30,x:415.1,y:294.1}).wait(1).to({graphics:mask_4_graphics_31,x:415.1,y:291.7}).wait(1).to({graphics:mask_4_graphics_32,x:415.1,y:289.3}).wait(1).to({graphics:mask_4_graphics_33,x:415.1,y:286.9}).wait(1).to({graphics:mask_4_graphics_34,x:415.1,y:284.5}).wait(1).to({graphics:mask_4_graphics_35,x:415.1,y:282.1}).wait(1).to({graphics:mask_4_graphics_36,x:415.1,y:279.7}).wait(1).to({graphics:mask_4_graphics_37,x:415.1,y:277.2}).wait(1).to({graphics:mask_4_graphics_38,x:415.1,y:274.8}).wait(1).to({graphics:mask_4_graphics_39,x:415.1,y:272.4}).wait(1).to({graphics:mask_4_graphics_40,x:415.1,y:270}).wait(1).to({graphics:mask_4_graphics_41,x:415.1,y:267.6}).wait(59));
	...
	var mask_5_graphics_13 = new cjs.Graphics().p("AtHBTIAAilIaPAAIAAClg");
	var mask_5_graphics_14 = new cjs.Graphics().p("AtHBwIAAjfIaPAAIAADfg");
	var mask_5_graphics_15 = new cjs.Graphics().p("AtHCNIAAkZIaPAAIAAEZg");
	var mask_5_graphics_16 = new cjs.Graphics().p("AtHCqIAAlTIaPAAIAAFTg");
	var mask_5_graphics_17 = new cjs.Graphics().p("AtHDHIAAmNIaPAAIAAGNg");
	var mask_5_graphics_18 = new cjs.Graphics().p("AtHDkIAAnHIaPAAIAAHHg");
	var mask_5_graphics_19 = new cjs.Graphics().p("AtHEBIAAoBIaPAAIAAIBg");
	var mask_5_graphics_20 = new cjs.Graphics().p("AtHEeIAAo7IaPAAIAAI7g");
	var mask_5_graphics_21 = new cjs.Graphics().p("AtHE7IAAp1IaPAAIAAJ1g");
	var mask_5_graphics_22 = new cjs.Graphics().p("AtHFYIAAqvIaPAAIAAKvg");
	var mask_5_graphics_23 = new cjs.Graphics().p("AtHF1IAArpIaPAAIAALpg");
	var mask_5_graphics_24 = new cjs.Graphics().p("AtHGSIAAsjIaPAAIAAMjg");
	var mask_5_graphics_25 = new cjs.Graphics().p("AtHGuIAAtbIaPAAIAANbg");
	var mask_5_graphics_26 = new cjs.Graphics().p("AtHHLIAAuVIaPAAIAAOVg");
	var mask_5_graphics_27 = new cjs.Graphics().p("AtHHoIAAvPIaPAAIAAPPg");
	var mask_5_graphics_28 = new cjs.Graphics().p("AtHIFIAAwJIaPAAIAAQJg");
	var mask_5_graphics_29 = new cjs.Graphics().p("AtHIiIAAxDIaPAAIAARDg");
	var mask_5_graphics_30 = new cjs.Graphics().p("AtHI/IAAx9IaPAAIAAR9g");
	var mask_5_graphics_31 = new cjs.Graphics().p("AtHJcIAAy3IaPAAIAAS3g");

	this.timeline.addTween(cjs.Tween.get(mask_5).to({graphics:null,x:0,y:0}).wait(12).to({graphics:mask_5_graphics_12,x:264.1,y:385.6}).wait(1).to({graphics:mask_5_graphics_13,x:264.1,y:382.8}).wait(1).to({graphics:mask_5_graphics_14,x:264.1,y:379.9}).wait(1).to({graphics:mask_5_graphics_15,x:264.1,y:377.1}).wait(1).to({graphics:mask_5_graphics_16,x:264.1,y:374.3}).wait(1).to({graphics:mask_5_graphics_17,x:264.1,y:371.4}).wait(1).to({graphics:mask_5_graphics_18,x:264.1,y:368.6}).wait(1).to({graphics:mask_5_graphics_19,x:264.1,y:365.7}).wait(1).to({graphics:mask_5_graphics_20,x:264.1,y:362.9}).wait(1).to({graphics:mask_5_graphics_21,x:264.1,y:360.1}).wait(1).to({graphics:mask_5_graphics_22,x:264.1,y:357.2}).wait(1).to({graphics:mask_5_graphics_23,x:264.1,y:354.4}).wait(1).to({graphics:mask_5_graphics_24,x:264.1,y:351.6}).wait(1).to({graphics:mask_5_graphics_25,x:264.1,y:348.7}).wait(1).to({graphics:mask_5_graphics_26,x:264.1,y:345.9}).wait(1).to({graphics:mask_5_graphics_27,x:264.1,y:343}).wait(1).to({graphics:mask_5_graphics_28,x:264.1,y:340.2}).wait(1).to({graphics:mask_5_graphics_29,x:264.1,y:337.4}).wait(1).to({graphics:mask_5_graphics_30,x:264.1,y:334.5}).wait(1).to({graphics:mask_5_graphics_31,x:264.1,y:331.7}).wait(69));
	...
	var mask_6_graphics_1 = new cjs.Graphics().p("ApDA1IAAhpISHAAIAABpg");
	var mask_6_graphics_2 = new cjs.Graphics().p("ApDBHIAAiNISHAAIAACNg");
	var mask_6_graphics_3 = new cjs.Graphics().p("ApDBZIAAixISHAAIAACxg");
	var mask_6_graphics_4 = new cjs.Graphics().p("ApDBrIAAjVISHAAIAADVg");
	var mask_6_graphics_5 = new cjs.Graphics().p("ApDB9IAAj5ISHAAIAAD5g");
	var mask_6_graphics_6 = new cjs.Graphics().p("ApDCPIAAkdISHAAIAAEdg");
	var mask_6_graphics_7 = new cjs.Graphics().p("ApDCiIAAlDISHAAIAAFDg");
	var mask_6_graphics_8 = new cjs.Graphics().p("ApDC0IAAlnISHAAIAAFng");
	var mask_6_graphics_9 = new cjs.Graphics().p("ApDDGIAAmLISHAAIAAGLg");
	var mask_6_graphics_10 = new cjs.Graphics().p("ApDDYIAAmvISHAAIAAGvg");
	var mask_6_graphics_11 = new cjs.Graphics().p("ApDDqIAAnTISHAAIAAHTg");
	var mask_6_graphics_12 = new cjs.Graphics().p("ApDD8IAAn3ISHAAIAAH3g");
	var mask_6_graphics_13 = new cjs.Graphics().p("ApDEPIAAodISHAAIAAIdg");
	var mask_6_graphics_14 = new cjs.Graphics().p("ApDEhIAApBISHAAIAAJBg");
	var mask_6_graphics_15 = new cjs.Graphics().p("ApDEzIAAplISHAAIAAJlg");
	var mask_6_graphics_16 = new cjs.Graphics().p("ApDFFIAAqJISHAAIAAKJg");
	var mask_6_graphics_17 = new cjs.Graphics().p("ApDFXIAAqtISHAAIAAKtg");
	var mask_6_graphics_18 = new cjs.Graphics().p("ApDFpIAArRISHAAIAALRg");
	var mask_6_graphics_19 = new cjs.Graphics().p("EgC4AhDIAAr4ISHAAIAAL4g");

	this.timeline.addTween(cjs.Tween.get(mask_6).to({graphics:mask_6_graphics_0,x:137,y:419.6}).wait(1).to({graphics:mask_6_graphics_1,x:137,y:417.8}).wait(1).to({graphics:mask_6_graphics_2,x:137,y:416}).wait(1).to({graphics:mask_6_graphics_3,x:137,y:414.1}).wait(1).to({graphics:mask_6_graphics_4,x:137,y:412.3}).wait(1).to({graphics:mask_6_graphics_5,x:137,y:410.5}).wait(1).to({graphics:mask_6_graphics_6,x:137,y:408.7}).wait(1).to({graphics:mask_6_graphics_7,x:137,y:406.9}).wait(1).to({graphics:mask_6_graphics_8,x:137,y:405}).wait(1).to({graphics:mask_6_graphics_9,x:137,y:403.2}).wait(1).to({graphics:mask_6_graphics_10,x:137,y:401.4}).wait(1).to({graphics:mask_6_graphics_11,x:137,y:399.6}).wait(1).to({graphics:mask_6_graphics_12,x:137,y:397.7}).wait(1).to({graphics:mask_6_graphics_13,x:137,y:395.9}).wait(1).to({graphics:mask_6_graphics_14,x:137,y:394.1}).wait(1).to({graphics:mask_6_graphics_15,x:137,y:392.3}).wait(1).to({graphics:mask_6_graphics_16,x:137,y:390.5}).wait(1).to({graphics:mask_6_graphics_17,x:137,y:388.6}).wait(1).to({graphics:mask_6_graphics_18,x:137,y:386.8}).wait(1).to({graphics:mask_6_graphics_19,x:97.5,y:211.5}).wait(81));
