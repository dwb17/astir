...
(lib.o2barrier = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(31).to({_off:false},0).to({x:111,y:89.5},20).to({x:91,y:103.5,alpha:0.219},8).to({_off:true},1).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(24).to({_off:false},0).to({x:124,y:63.5},20).to({x:111,y:53.5,alpha:0.219},9).to({_off:true},1).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(21).to({_off:false},0).to({x:149,y:60.5},19).to({x:134,y:39.5,alpha:0.219},9).to({_off:true},1).wait(15));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(17).to({_off:false},0).to({x:193.5,y:67.5},19).to({x:223.5,y:62.5,alpha:0.219},8).to({_off:true},1).wait(20));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(14).to({_off:false},0).to({rotation:56.7,x:147,y:53},17).to({x:157,y:34,alpha:0.219},10).to({_off:true},1).wait(23));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(11).to({_off:false},0).to({rotation:-13.4,x:188.1,y:62.4},17).to({rotation:-34.7,x:214.1,y:79.4,alpha:0.219},7).to({_off:true},1).wait(29));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(12).to({_off:false},0).to({x:111.5,y:70.5},19).to({x:92.5,y:87.5,alpha:0.219},8).to({_off:true},1).wait(25));

	// Layer 1
	this.instance_7 = new lib.Symbol1();
	this.instance_7.setTransform(260,260,1,1,0,0,0,270,0);
	this.instance_7.alpha = 0.219;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({x:270,alpha:1},10,cjs.Ease.get(1)).wait(55));
